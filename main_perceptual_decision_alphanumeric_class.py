...
def run_session(exp, block, is_partial, list_exposure_duration, all_lists_of_keyboard_constants, list_of_lists_validity, choice_nb_digits, instructions, nb_set):
...
if order is True:
	run_session(exp, block_1, True, exposure_conditions, all_lists_of_keyboard_constants_p, list_of_lists_allowed_digits_p, choice_nb_digits_p, instructions_partial, nb_set)
	run_session(exp, block_2, False, exposure_conditions, all_lists_of_keyboard_constants_w, list_of_lists_char_w, choice_nb_digits_w, instructions_whole, nb_set)
